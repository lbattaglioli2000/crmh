...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('nav a').hover(function () {
    var a = Math.random() * 10 - 5;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('transform', 'rotate(' + a + 'deg) scale(1.25)');
  }, function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('transform', 'none');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.map').each(function () {
    var mapEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);

    // get the address from the data attribute
    var address = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('address');
    var city = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('city');
    var state = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('state');
    var zip = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('zip');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('a[href*="#pantries"]').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href')).offset().top - 50
    }, 500, 'linear');
  });
});
